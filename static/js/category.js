...
//     embed.src = "/home/pi/LLM/Bot" + book_data[9]; // Assuming pdfData.pdfSrc contains the PDF source URL
//     embed.src = "../static/resources/test1.pdf"
...
function createPDFLink(book_data) {
    ...
    // iframe.src = "./Bot" + book_data[9];
    iframe.src = "../static/resources/test2.pdf"
    iframe.type = 'application/pdf';
    iframe.width = '100%';
    iframe.height = '100%'; // Adjust the height as needed
    pdfLink.appendChild(iframe);
    return pdfLink;
}
